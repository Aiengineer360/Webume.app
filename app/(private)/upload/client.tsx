...
export default function UploadPageClient() {
  ...
  useEffect(() => {
    ...
    if (resume?.file?.url && resume.file.name && resume.file.size) {
      console.log('Setting fileState to saved:', resume.file);
      setFileState({
        status: 'saved',
        file: {
      ...
      console.log('Resume file data incomplete:', resume?.file);
    }
  }, [resume]);
        ...
        <Dialog>
          <DialogTrigger asChild>
            ...
            >
              ...
              <p className="text-sm md:text-base font-medium text-center text-design-gray whitespace-normal">
