...
export async function generateMetadata({
  ...
  if (!user_id) {
    return {
      title: 'User Not Found | Webume.app',
      description: 'This user profile could not be found on Webume.app',
    };
  }

  if (!resume?.resumeData || resume.status !== 'live') {
    return {
      title: 'Resume Not Found | Webume.app',
      description: 'This resume could not be found on Webume.app',
    };
  }

  return {
    title: `${resume.resumeData.header.name}'s Resume | Webume.app`,
    ...
    openGraph: {
      ...
      images: [
        {
          url: `https://webume.app/${username}/og`,
          width: 1200,
          height: 630,
          alt: 'Webume.app Profile',
        },
      ],
    },
  };
